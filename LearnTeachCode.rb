module Learn
  class CLI < Thor
    ...
    desc 'new lab-name -t|--template template-name', 'Generate a new lesson repo using a Learn.Teach.Code template', hide: true
    ...
    desc 'hello', 'Verify your connection to Learn.Teach.Code'
    def hello
      exec('learn-hello')
    end
